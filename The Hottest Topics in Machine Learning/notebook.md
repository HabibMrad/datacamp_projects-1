...
#long_string = papers['title_processed'].to_string()
...
```
    ...
    Topic #0:
    learning neural networks multi deep
    
    Topic #1:
    information model neural variational inference
    
    Topic #2:
    models learning stochastic optimization linear
    
    Topic #3:
    efficient fast image estimation modeling
    
    Topic #4:
    learning gaussian regression processes process
