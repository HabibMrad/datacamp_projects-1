...
```
    ...
    <matplotlib.image.AxesImage at 0x7f511b0bfcf8>
...
![png](output_15_2.png)
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f5110c16a90>
...
def process_image(path):
    ...
    rcz = img.rotate(angle = 45).crop(box = (25, 25, 75, 75)).resize(size = (100, 100))
    rcz.save(rcz_path)
