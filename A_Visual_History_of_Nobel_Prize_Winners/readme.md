...
nobel.groupby(by = 'full_name').filter(lambda x : x['year'].count() >= 2)
```
...
sns.lmplot(x = 'year', y = 'age', data = nobel, lowess = True, aspect = 2,
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f81c4a77588>
...
sns.lmplot(x = 'year', y = 'age', data = nobel, lowess = True, aspect = 2,
          line_kws = {'color': 'black'}, row = 'category')
```




    <seaborn.axisgrid.FacetGrid at 0x7f81c4a59f98>
